...
debugger
    ...
    //判断是否为简介按钮
    var xx = Number(event.target.getAttribute('playUrlIndex'));
debugger;
...
debugger
  ...
  setAdsConfigure: function() {
    COLORAdController.sharedAdController().startWithAppIdentifier("178d8cad-103a-434e-ae5d-b5416b59c6d4");
