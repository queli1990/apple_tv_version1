...
func isPurchased() -> Bool {
    let xx = UserDefaults.standard.bool(forKey: "com.uu.VIP") || UserDefaults.standard.bool(forKey: "com.uu.VIP499")
    return xx
}
...
//    static let TVBaseURL = "http://47.93.83.7:8099/AppleTV-Versions/Version-1.2-statistics/server/"
    static let TVBaseURL = "http://47.93.83.7:8099/AppleTV-Versions/Version-1.3-feedbackMoney/server/"
//    static let TVBaseURL = "http://www.100uu.tv:8099/server/"
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        IAP.requestProducts(Set<ProductIdentifier>(arrayLiteral: "com.uu.VIP499"))
